    ...
    let num = req.query.number;
     ...
     try {
            ...
            Pair_Code_By_Venocyber_Tech.ev.on("connection.update", async (s) => {
               ...
               let VENOCYBER_X_TEXT = `
*_Pair Code Connected by Venocyber Tech 🥰🤪_*
*_Made With 🤍🍓_*
______________________________________
╔════◇
║ *『 🫂🫂WOW YOU CHOOSEN VENOCYBER X ʙᴏᴛs 🐒🐺 』*
...
║❒ *Repo:* _https://github.com/Venocybertech/veenocyber-X_
║❒ *WaGroup:* _https://chat.whatsapp.com/HSln3blDuuuKvC8njxyCCN_
║❒ *WaChannel:* _https://whatsapp.com/channel/0029VaZHLuR42DcfepqNuh1e_
║❒ *Plugins:* _https://github.com/Kingjux/venocyber-md-plugins_
╚══════════════════════╝ 
_____________________________________

_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Venocyber_Tech.sendMessage(Pair_Code_By_Venocyber_Tech.user.id,{text:VENOCYBER_X_TEXT},{quoted:session})
    ...
    return await VENOCYBER_X_PAIR_CODE()
});
